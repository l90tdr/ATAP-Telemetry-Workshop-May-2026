...
You will be expected to use the course materials to build your own scripts on your machines and execute, so please have R and Rstudio installed. The goal is to not just parrot but to learn how to write coherent scripts which you and others can reuse time and again. 
...
This dataset is part of the work that I carried out alongside many collaborators for my PhD thesis. The dataset forms part of a larger study which tracks the broad and finescale movement patterns of bronze whalers along the South African coastline, for which there are publicaitions in progress.
...
A reminder that the majority of the data used in this workshop is sourced from ATAP in the raw format that they export in. Provided you (and ATAP) maintain the export formats, rerunning the data interrogation with updated reports should be relatively seamless as new data comes in. The main complication will arise if you start manually changing your biomterics file or want to include different factors (which is completely fine). You'll then just have to fine tune this according to your data. 
...
In short no, well at least not ethically. Most universities and institutes have an AI policy so it would be well worth reading up on that before getting carried away. Unlike the forums and youtube of years gone by where you trawled for hours to make sense of things, AI can spit several different versions to you in a manner of seconds. When users understand the fundamentals of their data or analysis, then AI tools can complement research through efficiency and troubleshooting. However blindly following along could lead to the edge of a cliff and flawed results/interpretation pretty quickly. Through critical thinking and a hands on approach applied research is incredibly rewarding, don't let the machine take that! Interrogate and play with your data (in R of course), it's surprisingly fun.
