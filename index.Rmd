...
As with anything if we break things into small logical steps and harness some useful data sceince tools we can ensure that our workflows are efficient and repeatable so we don't waste eons searching for the csv that I swear I'd perfected. Therefore, after this workshop, you should be able to work in an R project environment to:
